...
class InvoiceModel(Base, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(String(50), default=InvoiceStatus.UPLOADED.value, nullable=False, index=True)
    ...
    supplier: Mapped[Optional["SupplierModel"]] = relationship("SupplierModel", back_populates="invoices")
